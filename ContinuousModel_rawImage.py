...
class DeepModel():
    ...
    def __loadModel(self):
        ...
        #     return kr.models.load_model('continuousModel_succeed.h5')
            ...
            image_layer = kr.layers.MaxPooling2D(pool_size=(4,4), name='maxpool_1')(image_layer)
            image_layer = kr.layers.Conv2D(filters=128, kernel_size=3, strides=(1, 1), activation='relu', name='image_conv2')(image_layer)
            image_layer = kr.layers.MaxPooling2D(pool_size=(4,4), name='maxpool_2')(image_layer)
            image_layer = kr.layers.Conv2D(filters=128, kernel_size=3, strides=(1, 1), activation='relu', name='image_conv3')(image_layer)
            image_layer = kr.layers.MaxPooling2D(pool_size=(2,2), name='maxpool_3')(image_layer)
        ...
        while True:
            ...
            for index in np.random.permutation(data.index):
                ...
                if actionType == 0: # normal
                    ...
                    newBrightnessDelta = np.random.normal(45, 15)
